-- ============================================================
--  Mates Aconcagua — Script de base de datos completo
--  Ejecutar una sola vez en MySQL Workbench con el rayo ⚡
-- ============================================================

DROP DATABASE IF EXISTS mates_aconcagua;

CREATE DATABASE mates_aconcagua CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- ── Admin ─────────────────────────────────────────────────────
-- Este UPDATE no hace nada si el email todavía no existe (el usuario debe
-- registrarse primero en la app). Podés volver a ejecutar solo esta línea
-- después de registrarte.

-- UPDATE users SET role = 'admin' WHERE email = 'enzocanepa8@gmail.com';
