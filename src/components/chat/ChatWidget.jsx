...
function getFallbackResponse(text) {
    ...
    if (t.includes('devoluci') || t.includes('cambio') || t.includes('devolver') || t.includes('retorno')) {
        return 'Tenés 30 días corridos desde que recibís tu pedido para hacer devoluciones o cambios. El producto debe estar en buen estado y sin uso. Escribinos a enzocanepa960@gmail.com 📬';
    }
    ...
    return 'Para consultas específicas sobre tu pedido, escribinos a enzocanepa960@gmail.com y te respondemos a la brevedad. 📩';
}
