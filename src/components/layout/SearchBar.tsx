...
export function DesktopSearchBar({ value, onChange }: { value: string; onChange: (v: string) => void }) {
...
export function MobileSearchOverlay({ value, onChange, onClose }: SearchBarProps) {
  const navigate = useNavigate();
