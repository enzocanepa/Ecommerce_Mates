    ...
    return (<div className="py-12 bg-gray-50 min-h-screen">
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center mb-8">
          ...
          <button onClick={clearCart} className="flex items-center gap-2 text-red-600 hover:text-red-700 transition-colors">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white p-6 rounded-lg shadow-md sticky top-24">
              ...
              {!user && (<div className="bg-blue-50 text-blue-700 p-3 rounded-lg text-sm mb-4">
                  Debes iniciar sesión para finalizar la compra
                </div>)}

              <button onClick={handleCheckout} className="w-full flex items-center justify-center gap-2 bg-[#c7e47d] text-[#4a5f2f] py-3 rounded-lg hover:bg-[#b8d66e] transition-colors text-lg font-semibold">
                <CreditCard className="w-5 h-5"/>
                Finalizar Compra
              </button>

              <Link to="/tienda" className="block text-center mt-4 text-[#6b8e3d] hover:text-[#a8c95f] transition-colors">
                Seguir Comprando
              </Link>
            </div>
          </div>
