    ...
    return (<div className="p-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6 mb-10">
        {stats.map((stat) => {
            ...
            return (<div key={stat.label} className="bg-white rounded-xl shadow-sm p-6 flex items-center gap-4">
          ...
          {Object.entries(byCategory).map(([cat, count]) => {
            ...
            return (<div key={cat}>
                ...
                <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
                  <div className="h-full bg-[#a8c95f] rounded-full transition-all" style={{ width: `${pct}%` }}/>
                </div>
              </div>);
        })}
        </div>
